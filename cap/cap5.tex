...
\begin{figure}[htb]
	...
	\subfloat[]{\includegraphics[scale=0.12, clip, trim=0cm 0cm 0cm 0cm]{imgs/cap4/GE_Proj5_Raw.png}}
	\hfil
	\subfloat[]{\includegraphics[scale=0.14, clip, trim=0cm 0cm 0cm 0cm]{imgs/cap4/HO_Proj8_Process.png}}
	\hfil
